...
const OPTIONS: Record<string, string[]> = {
  morningStudy: ['Library', 'Home', 'Café', 'Classroom', 'Outside'],
  lunch: ['Dining Hall', 'Off Campus', 'Home', 'Café', 'Skip'],
  afternoonStudy: ['Library', 'Home', 'Café', 'Classroom', 'Outside'],
  dinner: ['Dining Hall', 'Off Campus', 'Home', 'Café', 'Skip'],
